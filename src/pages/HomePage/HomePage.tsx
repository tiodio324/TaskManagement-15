...
export const HomePage = observer(() => {
  const { activeProjects, totalTasksCount, completedTasksCount, inProgressTasksCount, loadAllData, tasksLoading } = dataStore;
  const { isDeveloper, isAdmin } = authStore;
    ...
    <div className={styles.page}>
      <section className={styles.welcome}>
        <div className={styles.welcomeContent}>
          <h1 className={styles.welcomeTitle}>Система управления задачами</h1>
          <p className={styles.welcomeText}>
            Эффективное планирование и отслеживание проектов, спринтов и задач команды.
            {!isDeveloper && ' Войдите в систему для создания и редактирования задач.'}
          </p>
      ...
      <section className={styles.stats}>
        <StatCard title="Проектов" value={tasksLoading ? '...' : activeProjects.length} color="primary"
        ...
        <StatCard title="Всего задач" value={totalTasksCount} color="info"
        ...
        <StatCard title="В работе" value={inProgressTasksCount} color="warning"
        ...
        <StatCard title="Выполнение" value={`${completionRate}%`} color="success"
      ...
      <section className={styles.quickActions}>
        ...
        <div className={styles.actionCards}>
          <Card className={styles.actionCard} hoverable onClick={() => navigate('tasks')}>
            ...
            <h3>Задачи</h3>
            <p>Просмотр и управление задачами</p>
            {inProgressTasksCount > 0 && <Badge variant="warning">{inProgressTasksCount} в работе</Badge>}
          </Card>
          <Card className={styles.actionCard} hoverable onClick={() => navigate('projects')}>
            <div className={styles.actionIcon}>
            ...
            <h3>Проекты</h3>
            <p>Обзор активных проектов</p>
          </Card>
          <Card className={styles.actionCard} hoverable onClick={() => navigate('sprints')}>
            <div className={styles.actionIcon}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" /></svg>
            </div>
            <h3>Спринты</h3>
            <p>Планирование итераций</p>
          </Card>
          {isAdmin && (
            <Card className={styles.actionCard} hoverable onClick={() => navigate('admin')}>
              <div className={styles.actionIcon}>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="3" /><path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 010 2.83 2 2 0 01-2.83 0l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-2 2 2 2 0 01-2-2v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83 0 2 2 0 010-2.83l.06-.06a1.65 1.65 0 00.33-1.82 1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 010-2.83 2 2 0 012.83 0l.06.06a1.65 1.65 0 001.82.33H9a1.65 1.65 0 001-1.51V3a2 2 0 012-2 2 2 0 012 2v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 0 2 2 0 010 2.83l-.06.06a1.65 1.65 0 00-.33 1.82V9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z" /></svg>
              </div>
              <h3>Управление</h3>
